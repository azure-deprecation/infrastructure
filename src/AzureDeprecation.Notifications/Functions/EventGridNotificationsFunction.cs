...
namespace AzureDeprecation.Notifications.Functions
{
    public class EventGridNotificationsFunction
    {
        ...
        public async Task Run([ServiceBusTrigger("new-deprecation-notices-sandbox", "event-grid-notifications-sandbox", Connection = "ServiceBus_ConnectionString")] NewDeprecationNoticePublishedV1Message newDeprecationNoticePublishedV1Message, ILogger log)
        {
