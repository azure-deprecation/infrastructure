...
resource restApiOnFunctionsBackend 'Microsoft.ApiManagement/service/backends@2021-12-01-preview' = {
  ...
  properties: {
    ...
    protocol: 'http'
    resourceId: '${environment().resourceManager}${functionAppResource.id}'
    credentials: {
      query: {
      }
      header: {
  ...
  properties: {
    ...
    request: {
      queryParameters: [
        ...
        {
          name: 'deprecationYear'
          description: 'Format - int32. Filter to reduce deprecation notices by the year of the deprecation.'
          type: 'integer'
          values: []
          typeName: 'DeprecationYear'
        }
        {
          name: 'azureService'
        ...
        {
          name: 'pageOffset'
          description: 'Format - int32. Specifies the amount of pages to skip.'
          type: 'integer'
          values: []
          typeName: 'PageOffset'
        }
        {
          name: 'pageSize'
          description: 'Format - int32. Specifies the amount of entries in the page.'
          type: 'integer'
          values: []
          typeName: 'PageSize'
        }
